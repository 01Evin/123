...
json_content = {
    ...
    "hidden_tabs":["Extras","Train"],
    "ui_reorder": "inpaint, sampler, checkboxes, hires_fix, dimensions, cfg, seed, batch, override_settings, scripts",
    "ui_extra_networks_tab_reorder": "",
    "localization": "chinese-english-0722",
    ...
    "hide_samplers": ["Euler","LMS","Heun","DPM2","LMS Karras","DPM fast","DPM2 Karras","DPM++ 2M","DPM++ SDE"],
    "Show_grid_in_results_for_web": True,
    "For_inpainting_include_the_greyscale_mask_in_results_for_web": True,
    "eta_ddim": 0.0,
    "eta_ancestral": 1.0,
    ...
    "disabled_extensions": ["batchlinks-webui"],
